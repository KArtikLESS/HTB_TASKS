...
Получившийся при экспорте файл можно назвать по-разному и добавить в папку с .apk файлом. Мной он был назван `cert_burp.der`.
...
Сертификат в приложении хранится в формате .pem, поэтому для нашего сертификата тоже стоит изменить расширение.
